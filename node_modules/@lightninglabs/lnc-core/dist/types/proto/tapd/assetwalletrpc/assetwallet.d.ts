...
export interface AssetWallet {
     ...
     */
    commitVirtualPsbts(request?: DeepPartial<CommitVirtualPsbtsRequest>): Promise<CommitVirtualPsbtsResponse>;
    /**
     ...
     */
    publishAndLogTransfer(request?: DeepPartial<PublishAndLogRequest>): Promise<SendAssetResponse>;
    /**
    ...
    queryInternalKey(request?: DeepPartial<QueryInternalKeyRequest>): Promise<QueryInternalKeyResponse>;
    /**
     * QueryScriptKey returns the full script key descriptor for the given tweaked
     * script key.
     */
    queryScriptKey(request?: DeepPartial<QueryScriptKeyRequest>): Promise<QueryScriptKeyResponse>;
    /**
     ...
     */
    declareScriptKey(request?: DeepPartial<DeclareScriptKeyRequest>): Promise<DeclareScriptKeyResponse>;
}
