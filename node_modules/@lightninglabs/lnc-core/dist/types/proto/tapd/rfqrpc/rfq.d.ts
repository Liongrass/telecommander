...
export declare enum QuoteRespStatus {
    /**
...
export interface Rfq {
     ...
     * asset channel.
     */
    addAssetBuyOrder(request?: DeepPartial<AddAssetBuyOrderRequest>): Promise<AddAssetBuyOrderResponse>;
    /**
     ...
     */
    addAssetSellOrder(request?: DeepPartial<AddAssetSellOrderRequest>): Promise<AddAssetSellOrderResponse>;
    /**
     ...
     */
    addAssetSellOffer(request?: DeepPartial<AddAssetSellOfferRequest>): Promise<AddAssetSellOfferResponse>;
    /**
     * tapcli: `rfq buyoffer`
     ...
     */
    addAssetBuyOffer(request?: DeepPartial<AddAssetBuyOfferRequest>): Promise<AddAssetBuyOfferResponse>;
    /**
     ...
     */
    queryPeerAcceptedQuotes(request?: DeepPartial<QueryPeerAcceptedQuotesRequest>): Promise<QueryPeerAcceptedQuotesResponse>;
    /** SubscribeRfqEventNtfns is used to subscribe to RFQ events. */
    subscribeRfqEventNtfns(request?: DeepPartial<SubscribeRfqEventNtfnsRequest>, onMessage?: (msg: RfqEvent) => void, onError?: (err: Error) => void): void;
}
