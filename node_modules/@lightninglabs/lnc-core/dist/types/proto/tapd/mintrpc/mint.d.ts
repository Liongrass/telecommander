...
export interface Mint {
     ...
     */
    fundBatch(request?: DeepPartial<FundBatchRequest>): Promise<FundBatchResponse>;
    /**
     ...
     * directly.
     */
    sealBatch(request?: DeepPartial<SealBatchRequest>): Promise<SealBatchResponse>;
    /**
     ...
     * creation batches.
     */
    subscribeMintEvents(request?: DeepPartial<SubscribeMintEventsRequest>, onMessage?: (msg: MintEvent) => void, onError?: (err: Error) => void): void;
}
