...
import type { PeerAcceptedSellQuote, PeerAcceptedBuyQuote } from '../rfqrpc/rfq';
import type { Payment, Invoice, AddInvoiceResponse as AddInvoiceResponse2, PayReq } from '../lightning';
...
export interface TaprootAssetChannels {
     ...
     */
    fundChannel(request?: DeepPartial<FundChannelRequest>): Promise<FundChannelResponse>;
    /**
     ...
     * validation.
     */
    encodeCustomRecords(request?: DeepPartial<EncodeCustomRecordsRequest>): Promise<EncodeCustomRecordsResponse>;
    /**
     ...
     * amount.
     */
    sendPayment(request?: DeepPartial<SendPaymentRequest>, onMessage?: (msg: SendPaymentResponse) => void, onError?: (err: Error) => void): void;
    /**
     ...
     */
    addInvoice(request?: DeepPartial<AddInvoiceRequest>): Promise<AddInvoiceResponse>;
    /**
     ...
     */
    decodeAssetPayReq(request?: DeepPartial<AssetPayReq>): Promise<AssetPayReqResponse>;
}
...
export {};
//# sourceMappingURL=tapchannel.d.ts.map